          ...
          <AnimatePresence mode='wait'>
            <motion.div className='space-y-10 my-10'>
              {generatedChat && (
                <>
                  <div>
                    <h2 className='text-center max-w-xl sm:text-4xl text-3xl font-bold text-slate-900 mx-auto dark:text-gray-100'>
                      {t('simplifiedContent')}
                    </h2>
                  </div>
                  <div className='space-y-8 flex flex-col items-center justify-center max-w-xl mx-auto'>
                    <div
                      className='bg-gray-100 rounded-xl shadow-md p-4 hover:bg-white  transition cursor-copy border'
                      onClick={() => {
                    ...
                    >
                      ...
                      <p
                        className='sty1 markdown-body text-slate-700'
